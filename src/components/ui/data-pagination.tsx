...
export function DataPagination({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-t border-gray-50 bg-gray-100/40">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500">
        ...
        {total > 0 && (
          <span className="ml-1 text-gray-400 tabular-nums">
            {start}–{end} dari <span className="font-medium text-gray-700">{total}</span>
          </span>
        )}
        {total === 0 && (
