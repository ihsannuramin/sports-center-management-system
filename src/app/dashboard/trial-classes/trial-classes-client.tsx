  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-3 gap-4">
        <Card className="border-gray-50 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Total Kelas Trial</p><p className="text-2xl font-bold text-gray-900">{totalTrials}</p></CardContent></Card>
        <Card className="border-gray-50 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Total Peserta</p><p className="text-2xl font-bold text-blue-600">{totalParticipants}</p></CardContent></Card>
        <Card className="border-gray-50 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Dikonversi</p><p className="text-2xl font-bold text-green-600">{converted}</p></CardContent></Card>
      </div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((trial) => (
            <Card key={trial.id} className="border-gray-50 shadow-sm hover:shadow-md transition-all">
