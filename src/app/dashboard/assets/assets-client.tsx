  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-3 gap-4">
        <Card className="border-gray-100 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Total Aset</p><p className="text-2xl font-bold text-gray-900">{assets.length}</p></CardContent></Card>
        <Card className="border-gray-100 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Total Nilai</p><p className="text-xl font-bold text-gray-900">Rp {totalValue.toLocaleString("id-ID")}</p></CardContent></Card>
        <Card className="border-gray-100 shadow-sm"><CardContent className="p-4"><p className="text-xs text-gray-400 mb-1">Perlu Perbaikan</p><p className="text-2xl font-bold text-red-500">{needsRepair}</p></CardContent></Card>
      </div>
      ...
      {paginated.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {paginated.map((asset) => (
            <Card key={asset.id} className="border-gray-100 shadow-sm hover:shadow-md transition-all">
