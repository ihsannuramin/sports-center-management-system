      ...
      <div className="flex flex-1 flex-col gap-5 p-5">
                ...
                <Card className={`card-hover cursor-pointer group border ${card.border} h-full`}>
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <ArrowUpRight className="w-4 h-4 text-gray-200 group-hover:text-orange-500 transition-colors" />
                    </div>
        ...
        <div>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {/* Revenue card */}
            <Card className="lg:col-span-1 border-gray-50">
              <CardContent className="p-5">
            ...
            <Card className="lg:col-span-1 border-gray-50">
              <CardContent className="p-5">
                ...
                <Link
                  href="/dashboard/invoices"
                  className="mt-4 flex items-center gap-1 text-xs font-medium text-orange-500 hover:text-orange-500 transition-colors"
                >
...
async function DashboardCourtStatus() {
  try {
    ...
    const getStatus = (c: typeof courts[0]) => {
      ...
      if (schedType === "MAINTENANCE") return { label: "Perawatan", cls: "bg-red-50 text-red-500 border border-red-100" };
      if (schedType === "ACADEMY") return { label: "Latihan", cls: "bg-blue-50 text-blue-600 border border-blue-100" };
      if (c.rentalBookings.length > 0) return { label: "Disewa", cls: "bg-orange-50 text-orange-500 border border-orange-200" };
