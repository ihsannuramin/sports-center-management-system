      ...
      <div className="grid grid-cols-5 gap-3">
        {funnel.map((f) => (
          <button
            ...
            className={`p-3 rounded-xl border text-center transition-all ${stageFilter === f.stage ? "border-orange-400 bg-orange-50" : "border-gray-50 bg-white hover:border-orange-200"}`}
          >
            ...
            <tbody className="divide-y divide-gray-50">
              {paginated.map((lead) => (
                <tr key={lead.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-xs bg-gray-50 text-gray-700 px-2 py-0.5 rounded-full">{lead.source}</span>
                  </td>
                  <td className="px-4 py-3">
                    <select
                      value={lead.stage}
