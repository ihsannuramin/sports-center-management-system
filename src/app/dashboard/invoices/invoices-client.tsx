      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="border-red-100 bg-red-50/30 shadow-sm">
          <CardContent className="p-4">
            ...
            <p className="text-xl font-bold text-red-500">Rp {totalUnpaid.toLocaleString("id-ID")}</p>
          </CardContent>
        </Card>
        ...
        <CardHeader className="pb-4 border-b border-gray-50">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex gap-2 flex-wrap items-center">
              ...
              <Button variant="outline" size="sm" className="h-9 border-gray-200 text-gray-700" onClick={() => setBulkOpen(true)}>
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((inv) => (
                  <TableRow key={inv.id}>
                    ...
                    <TableCell><span className="text-sm text-gray-700">{format(new Date(inv.dueDate), "d MMM yyyy")}</span></TableCell>
