                ...
                return (
                  <TableRow key={a.id}>
                    ...
                    {skills.map((s) => (
                      <TableCell key={s}>
                        <div className="flex items-center gap-1.5">
                          <span className="text-sm font-semibold text-gray-900 w-7 text-right">{a[s]}</span>
                    ...
                    <TableCell className="pr-3">
                      <Button variant="ghost" size="sm" className="h-7 text-xs text-gray-500 hover:text-gray-900" onClick={() => openEdit(a)}>Edit</Button>
                    </TableCell>
                  </TableRow>
                );
              })
        ...
        <DialogContent className="max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-1">
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-3">
              <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide">Nilai Skill (0–100)</p>
              <div className="grid grid-cols-2 gap-3">
                {skills.map((s) => (
