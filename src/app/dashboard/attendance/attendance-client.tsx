...
const statusOptions = [
  ...
  { value: "ABSENT", label: "Absen", color: "bg-red-100 text-red-500" },
  ...
  return (
    <Tabs defaultValue="input">
      ...
      <TabsContent value="input" className="space-y-4 mt-4">
        <Card className="overflow-visible border-gray-50 shadow-sm">
          ...
          <Card className="border-gray-50 shadow-sm">
            <CardHeader className="flex-row items-center justify-between pb-4 border-b border-gray-50">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm bg-red-100 text-red-500 px-2 py-1 rounded-full">Absen: {absentCount}</span>
                  ...
                  {recapSummary.map((r) => {
                    ...
                    return (
                      <TableRow key={r.name}>
                        ...
                        <TableCell className="text-gray-700">{r.total}</TableCell>
          ...
          <CardContent className="overflow-visible pt-4">
            ...
            {coachClass && (
              <div className="mt-4 space-y-3">
                <div className="p-4 rounded-xl border border-gray-50 bg-gray-50">
                  <p className="text-sm font-medium text-gray-900">
                    Pelatih: <span className="text-orange-500">{coachClassData?.coach?.name || "Tidak ada"}</span>
                  </p>
