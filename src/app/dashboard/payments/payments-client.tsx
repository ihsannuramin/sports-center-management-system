                ...
                paginated.map((p) => (
                  <TableRow key={p.id}>
                    <TableCell className="pl-5">
                      <span className="text-sm text-gray-700">{format(new Date(p.createdAt), "d MMM yyyy")}</span>
                    ...
                    <TableCell>
                      {p.status === "PENDING" && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <Button size="sm" variant="outline" onClick={() => handleReject(p.id)} title="Tolak" className="text-red-500 border-red-100 hover:bg-red-50 h-8 w-8 p-0 cursor-pointer">
