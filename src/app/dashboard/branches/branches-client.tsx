    ...
    <div className="space-y-5">
      ...
      {paginated.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {paginated.map((b) => (
            <Card key={b.id} className={`border-gray-50 shadow-sm transition-all hover:shadow-md ${!b.isActive ? "opacity-60" : ""}`}>
              ...
              <CardContent className="pt-0">
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  <div className="text-center p-2.5 bg-orange-50 rounded-xl">
                    ...
                    <p className="text-xl font-bold text-orange-500 leading-tight">{b._count?.courts || 0}</p>
                    <p className="text-xs text-orange-500 mt-0.5">Lapangan</p>
                  </div>
                </div>
