      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
              ...
              return (
                <div key={i} className="flex items-center gap-2 flex-1">
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <span className={`text-xs font-medium hidden sm:block ${isActive ? "text-orange-500" : isDone ? "text-green-600" : "text-gray-400"}`}>
                      {label}
                    </span>
                  </div>
        ...
        {step === 3 && result && (
          <div className="bg-white rounded-md border border-gray-50 shadow-sm p-8 text-center">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-md p-4 mb-6 text-left space-y-2">
              <p className="text-xs font-semibold text-orange-500 mb-3">Detail Pendaftaran</p>
              ...
              <div className="pt-2 border-t border-orange-200">
                ...
                <p className="text-base font-bold text-orange-500">{result.student.studentNumber}</p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full border border-gray-200 text-gray-700 py-2.5 rounded-full font-medium text-sm hover:bg-gray-50 transition-colors"
            >
              Daftar Siswa Lain
            </button>
          </div>
        ...
        {step === 1 && (
          <div className="space-y-5">
            <div>
              <h1 className="headline-sm text-gray-900 mb-1">Data Siswa</h1>
              <p className="text-sm text-gray-400">Lengkapi informasi calon siswa baru</p>
            </div>

            {error && (
              <div className="flex items-center gap-2 text-sm text-red-500 bg-red-50 border border-red-100 rounded-md px-4 py-3">
            ...
            <div className="bg-white rounded-md border border-gray-50 shadow-sm p-5 space-y-4">
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Nama Lengkap Siswa *</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full border border-gray-200 rounded-full pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="label-md text-gray-700 block mb-1.5">Jenis Kelamin *</label>
                  <select
                    value={form.gender}
                ...
                <div>
                  <label className="label-md text-gray-700 block mb-1.5">Tanggal Lahir</label>
                  <div className="relative">
              ...
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Nomor HP Siswa (opsional)</label>
                <div className="relative">
              ...
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Alamat</label>
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-200 rounded-full pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-md border border-gray-50 shadow-sm p-5 space-y-4">
              ...
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Pilih Cabang *</label>
                <select
                  value={form.branchId}
              ...
              {form.branchId && (
                <div>
                  <label className="label-md text-gray-700 block mb-1.5">Pilih Kelas (opsional)</label>
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3.5 rounded-full font-semibold text-sm transition-colors flex items-center justify-center gap-2 shadow-md shadow-orange-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <button type="button" onClick={() => setStep(1)} className="flex items-center gap-1 text-sm text-gray-400 hover:text-gray-700 mb-4 transition-colors">
                <ArrowLeft className="w-3.5 h-3.5" /> Kembali
              </button>
              <h1 className="headline-sm text-gray-900 mb-1">Data Orang Tua / Wali</h1>
            ...
            <div className="bg-white rounded-md border border-gray-50 shadow-sm p-5 space-y-4">
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Nama Orang Tua / Wali *</label>
                <div className="relative">
              ...
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Email (opsional)</label>
                <div className="relative">
              ...
              <div>
                <label className="label-md text-gray-700 block mb-1.5">Alamat (opsional)</label>
                <div className="relative">
                  <MapPin className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                  <textarea
                    rows={2}
            ...
            {/* Review summary */}
            <div className="bg-orange-50 border border-orange-200 rounded-md p-4 space-y-2 text-sm">
              <p className="font-semibold text-orange-500 text-xs mb-3">Ringkasan Pendaftaran</p>
              <div className="flex items-center gap-2 text-gray-700"><User className="w-4 h-4 text-gray-400" /> {form.studentName}</div>
